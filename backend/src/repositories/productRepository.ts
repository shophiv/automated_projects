...
export class ProductRepository {
  static async create(tenantId: string, data: any): Promise<Product> {
    const query = `
  ...
  static async findById(tenantId: string, id: string): Promise<Product | null> {
    const query = `
      SELECT * FROM products
  ...
  static async update(tenantId: string, id: string, data: any): Promise<Product | null> {
    const query = `
      UPDATE products
  ...
  static async duplicate(tenantId: string, id: string): Promise<Product | null> {
